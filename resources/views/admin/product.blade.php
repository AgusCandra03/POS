        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <label class="col-md-6" name="code" id="code"></label>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
              ...
              <label class="col-md-1">:</label>
              <label class="col-md-6" name="description" id="description"></label>
          </div>
          <div class="form-group">
            <label class="col-md-4">Stock</label>
            <label class="col-md-1">:</label>
            <label class="col-md-6" name="stock" id="stock"></label>
          </div>
          <div class="form-group">
            <label class="col-md-4">Price</label>
            <label class="col-md-1">:</label>
            <label class="col-md-6" name="price" id="price"></label>
          </div>
          <div class="form-group">
            <label class="col-md-4">Category</label>
            <label class="col-md-1">:</label>
            <label class="col-md-6" name="categories.name" id="category_id"></label>
        </div>
